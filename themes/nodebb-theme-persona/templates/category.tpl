...
<div class="row">
    <div class="category <!-- IF widgets.sidebar.length -->col-lg-9 col-sm-12<!-- ELSE -->col-lg-12<!-- ENDIF widgets.sidebar.length -->">
        ...
        <div class="topic-list-header clearfix">
            ...
            <a href="{config.relative_path}/compose?cid={cid}&anonymous=true" component="category/post/anonymous" id="post_anonymous" class="btn btn-primary" data-ajaxify="false" role="button">Post as Anonymous</a>
